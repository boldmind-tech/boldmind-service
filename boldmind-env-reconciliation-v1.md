...
| -------------------------------------------- | ---------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| WhatsApp access token                        | `META_WHATSAPP_ACCESS_TOKEN`, `WHATSAPP_ACCESS_TOKEN`, `META_WHATSAPP_TOKEN`                         | `META_WHATSAPP_ACCESS_TOKEN`                                                                                                                                               | Matches every doc (system-design §5, canonical, master design) and the `WhatsAppProvider` constructor signature already spec'd                                                                                                                                                                                                                                             | Grep all 3 names in `notification/` and `packages/sms/`; consolidate reads to the kept name; delete the other two from Railway once confirmed unused                                                                                                                                                 |
